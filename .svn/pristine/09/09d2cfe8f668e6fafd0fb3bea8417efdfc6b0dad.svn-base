...
namespace JahanAraShop.Controllers.Bank
{
    public partial class GatewayController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected GatewayController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public GatewayController Actions { get { return MVC.Gateway; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Gateway";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Gateway";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_GatewayController : JahanAraShop.Controllers.Bank.GatewayController
    {
        public T4MVC_GatewayController() : base(Dummy.Instance) { }
