...
namespace JahanAraShop.Getaway
{
    public class BankMellatImplement
    {
        ...
        public static readonly string CallBackUrl = "http://jahanaraco.com//Payment/BankCallback";
        private static readonly long TerminalId = long.Parse("3743502");
        private const string UserName = "jahan85";
        private const string Password = "49510789";

        readonly string _localDate;
        readonly string _localTime;
        #endregion
        ...
        public string BpPayRequest(long orderId, long priceAmount, string additionalText)
        {
            try
            {
                ...
                var webService = new ir.shaparak.bpm.PaymentGatewayImplService();
                return webService.bpPayRequest(TerminalId, UserName, Password, orderId, priceAmount, _localDate, _localTime,
        ...
        public string DescribtionStatusCode(int statusCode)
        {
            switch (statusCode)
            {
                case 0:
